...
public class Street {
    ...
    public static void init() {
        ...
        streets.add(new Street("Indiana Avenue", "Red", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(-29f, 0f, -75f), new Vector3(-29f, 0f, -69f), new Vector3(-23f, 0f, -75f), new Vector3(-23f, 0f, -69f)));
        streets.add(new Street("Illinois Avenue", "Red", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(-16f, 0f, -75f), new Vector3(-16f, 0f, -69f), new Vector3(-10f, 0f, -75f), new Vector3(-10f, 0f, -69f)));
        ...
        streets.add(new Street("Atlantic Avenue", "Yellow", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(10f, 0f, -75f), new Vector3(10f, 0f, -69f), new Vector3(16f, 0f, -75f), new Vector3(16f, 0f, -69f)));
        streets.add(new Street("Ventnor Avenue", "Yellow", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(23f, 0f, -75f), new Vector3(23f, 0f, -69f), new Vector3(29f, 0f, -75f), new Vector3(29f, 0f, -69f)));
        streets.add(new Street("Water Works", "neutral", StreetType.FACILITY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(36f, 0f, -75f), new Vector3(36f, 0f, -69f), new Vector3(42f, 0f, -75f), new Vector3(42f, 0f, -69f)));
        streets.add(new Street("Marvin Gardens", "Yellow", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(50f, 0f, -75f), new Vector3(50f, 0f, -69f), new Vector3(56f, 0f, -75f), new Vector3(56f, 0f, -69f)));
        ...
        streets.add(new Street("Pacific Avenue", "Green", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(69f, 0f, -56f), new Vector3(69f, 0f, -50f), new Vector3(75f, 0f, -56f), new Vector3(75f, 0f, -50f)));
        streets.add(new Street("North Carolina Avenue", "Green", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(69f, 0f, -43f), new Vector3(69f, 0f, -37f), new Vector3(75f, 0f, -43f), new Vector3(75f, 0f, -37f)));
        ...
        streets.add(new Street("Park Place", "DarkBlue", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(69f, 0f, 23f), new Vector3(69f, 0f, 29f), new Vector3(75f, 0f, 23f), new Vector3(75f, 0f, 29f)));
        ...
        streets.add(new Street("Boardwalk", "DarkBlue", StreetType.PROPERTY, 0, 0, 0, 0, new int[] {0,0,0,0,0}, 0, new Vector3(69f, 0f, 50f), new Vector3(69f, 0f, 56f), new Vector3(75f, 0f, 50f), new Vector3(75f, 0f, 56f)));
    }
